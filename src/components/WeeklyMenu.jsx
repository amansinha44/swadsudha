...
const WeeklyMenu = () => {
  ...
  return (
    // Width slightly increased to 1074px (approx 5xl + 50px)
    <section className="py-12 px-4 sm:px-6 font-body w-full max-w-[1100px] mx-auto relative z-10">
      
      {/* --- Paper Card Container --- */}
      <div className="bg-white/95 backdrop-blur-md rounded-3xl shadow-[0_15px_50px_rgba(0,0,0,0.1)] p-6 md:p-12 lg:p-16 border border-gray-100">
        
        {/* --- Top Header & USPs --- */}
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-heading text-[#2d4d1d] mb-6 drop-shadow-sm">Our Menu</h2>
          <div className="flex flex-wrap justify-center gap-3 md:gap-5">
            <span className="flex items-center gap-1.5 text-sm font-semibold text-[#568a35] bg-[#568a35]/10 px-4 py-1.5 rounded-full">
              <Leaf size={16} /> Pure Veg
            </span>
            <span className="flex items-center gap-1.5 text-sm font-semibold text-yellow-600 bg-yellow-50 px-4 py-1.5 rounded-full">
              <Droplets size={16} /> Desi Ghee
            </span>
            <span className="flex items-center gap-1.5 text-sm font-semibold text-blue-600 bg-blue-50 px-4 py-1.5 rounded-full">
        ...
        <div className="mb-16">
          <h3 className="text-2xl font-heading text-[#568a35] mb-8 border-b border-gray-200 pb-2">Pricing Plans</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
            {pricingPlans.map((plan, idx) => (
              <div key={idx} className="relative group">
                <div className="flex items-baseline w-full">
                  <h4 className={`text-lg font-bold transition-colors ${plan.highlight ? 'text-[#467b2d]' : 'text-gray-800 group-hover:text-[#467b2d]'}`}>
                    {plan.name}
                  </h4>
                  ...
                  <span className={`text-xl font-bold ${plan.highlight ? 'text-[#467b2d]' : 'text-gray-900'}`}>
                    ₹{plan.price}
                  </span>
                </div>
        ...
        <div className="mb-12">
          ...
          <div className="flex overflow-x-auto hide-scrollbar justify-start md:justify-center gap-3 mb-10 pb-4 border-b border-gray-100">
            {menuData.map((data, index) => (
              <button
                key={index}
                onClick={() => setActiveDay(index)}
                className={`whitespace-nowrap px-6 py-2.5 rounded-full font-bold text-sm transition-all duration-300 border ${activeDay === index ? 'bg-[#467b2d] text-white border-[#467b2d] shadow-md scale-105' : 'bg-transparent text-gray-500 hover:text-gray-800 border-gray-200 hover:border-gray-300'}`}
              >
                {data.day}
              </button>
            ))}
          ...
          <div className="animate-in fade-in zoom-in-95 duration-300">
            <div className="text-center mb-10">
              ...
              <p className="text-[#568a35] font-heading text-xl mt-1 tracking-wider">{menuData[activeDay].theme}</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10">
              ...
              <div className="md:col-span-2 lg:col-span-1">
                <div className="flex items-baseline w-full mb-3">
                  <h4 className="text-2xl font-heading text-[#568a35]">Breakfast</h4>
                  <div className="flex-grow border-b-2 border-dotted border-[#568a35]/30 mx-4 relative top-[-6px]"></div>
                </div>
                <p className="text-gray-700 font-medium leading-relaxed pr-4">
              ...
              <div>
                <div className="flex items-baseline w-full mb-3">
                  <h4 className="text-2xl font-heading text-[#568a35]">Lunch</h4>
                  <div className="flex-grow border-b-2 border-dotted border-[#568a35]/30 mx-4 relative top-[-6px]"></div>
                </div>
                <p className="text-gray-700 font-medium leading-relaxed pr-4">
              ...
              <div className="md:col-span-2">
                <div className="flex items-baseline w-full mb-3">
                  <h4 className="text-2xl font-heading text-[#568a35]">Dinner</h4>
                  <div className="flex-grow border-b-2 border-dotted border-[#568a35]/30 mx-4 relative top-[-6px]"></div>
                </div>
                <p className="text-gray-700 font-medium leading-relaxed pr-4 md:w-3/4">
      ...
      {/* --- Floating Bottom CTA --- */}
      <div className="mt-8 bg-gradient-to-r from-[#1b360f] to-[#467b2d] rounded-2xl p-5 md:p-8 text-white flex flex-col md:flex-row items-center justify-between gap-5 shadow-2xl relative overflow-hidden border border-[#568a35]/30 mx-2 md:mx-10">
        <div className="absolute top-0 right-0 w-64 h-64 bg-white opacity-5 rounded-full blur-3xl transform translate-x-1/2 -translate-y-1/2"></div>
        
        <div className="relative z-10 flex-1 text-center md:text-left">
          <div className="flex items-center justify-center md:justify-start gap-2 mb-2 text-[#a4e363] font-semibold text-sm tracking-wide">
          ...
          <p className="text-green-100/80 text-sm">Aaj hi apna order book karein with Yummy Offers.</p>
        </div>
        
        <div className="relative z-10 shrink-0 w-full md:w-auto mt-2 md:mt-0">
          <a href="tel:+917007948170" className="flex items-center justify-center gap-2 bg-white text-[#467b2d] px-8 py-3.5 rounded-xl font-bold hover:bg-gray-100 transition-all shadow-md active:scale-95">
